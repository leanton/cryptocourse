...
public class TxHandler {
    ...
    /**
     * Creates a public ledger whose current me.antonle.crypto.scrooge.UTXOPool (collection of unspent transaction outputs) is
    ...
    /**
     * @return true if:
     * (1) all outputs claimed by {@code tx} are in the current me.antonle.crypto.scrooge.UTXO pool,
